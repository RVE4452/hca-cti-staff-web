...
rh = window.rh;
model = rh.model;
var defaultTopic = "Welcome_to_MyScheduler.htm";
rh._.exports(defaultTopic);
rh.consts('DEFAULT_TOPIC', encodeURI("Welcome_to_MyScheduler.htm"));
rh.consts('HOME_FILEPATH', encodeURI('index.htm'));
rh.consts('START_FILEPATH', encodeURI('index.htm'));
rh.consts('HELP_ID', '9128997a-98f9-41bc-9d01-1c070654f651' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "MyScheduler User Manual");
