    ...
    <div class="container pheadingNavigation0 containerWidth">
        <div class="row profileMainDiv" v-bind:class="{ 'sidepanel-open': isSharedPanelOpen }">
            ...
            <div class="flex flex-column neu-background--white">
                <neu-sub-left-nav name={{userName}} color="plain" side="left" @v-neu-change="myFunction"
                    class="mobile-menu profile-mobile-header no-print vh-100">
            ...
            <!-- Desktop NAV -->
            <neu-sub-left-nav name={{userName}} color="plain" side="left" @v-neu-change="myFunction"
                class="col-sm-4 profile-desktop-header profile-nav flex40 no-print vh-100">
            ...
            <div v-if="isNotificationMessageVisible">
                <SaveMsgPopUp @closeModal="closeSMPModal" :msgValue="msgValue" :classFlag="classFlag"></SaveMsgPopUp>
            </div>
        </div>
...
export default defineComponent({
    ...
    props: {},
    components: {
        EmploymentDetails, SchedulingPref,
        // SMSPref, 
        // NotificationMgmt,
