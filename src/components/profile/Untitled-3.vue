<template>
    <neu-container>
        <neu-container class="profile-component mw-100">
            <neu-sub-left-nav name="NAVIGATION" color="plain" side="left" style="min-height: 100vh;" class="mh-100" @v-neu-change="myFunction">
                <neu-item class="pl-3" @click="$router.push('/' +'EmployeeDetails')">
                <neu-stepper slot="start" selected="isSelected('EmpDtls')">
                ...
                <neu-stepper slot="start" selected="isSelected('SchPref')">
                    <neu-icon slot="start">calendar_month</neu-icon>
                </neu-stepper>
                
                <neu-label> Scheduler Preference </neu-label>
                <!-- <neu-icon slot="end">navigate_next</neu-icon> -->
                </neu-item>
                <neu-item  class="pl-3 flex justify-content-center" @click="routeNavigation('PayrollDetails')">
                <neu-stepper slot="start" selected="isSelected('PayrollDtls')">
            ...
            <nue-container class="employeedetails-component" v-if="isSelected('EmpDtls')">
                <!-- <EmploymentDetails></EmploymentDetails> --><p>Employee Details</p>
            </nue-container>
            <nue-container class="employeedetails-component" v-if="isSelected('SchPref')">
                <!-- <SchedulingPref /> --><p>SchedulingPref</p>
            </nue-container>
            <nue-container class="employeedetails-component" v-if="isSelected('PayrollDtls')">
                <!-- <PayrollDetails /> --><p>PayrollDetails</p>
            </nue-container>
        </neu-container>
        ...
        export default defineComponent({
            ...
            methods: {
                ...
                isSelected(selectedTabVal: string) {
                    debugger;
                    console.log(this.selectedTab === selectedTabVal)
