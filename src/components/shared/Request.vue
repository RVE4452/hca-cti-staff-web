<template>
  <div class="col-12">
        ...
        <div class="col-md-12 pb4">
          <div class="row">
            <div class="col-12">
              ...
              <!-- <model-list-select :options="availableShifts" name="ddlShift" v-bind:class="[
            ...
            <neu-select ref="ddlShift" interface="popover" :value="shift" @v-neu-change="shiftChange(additionalRequestEvent)">
                <neu-option :value="'one'" :key="'one'">
                    Select Shift
                </neu-option>
                <neu-option ref="ddlShiftOptions" v-for="shift in availableShifts" :value="shift.id" :key="shift.id">
                    {{shift.name}}
                </neu-option>
            </neu-select>
            ...
            <div class="col-12">
              <div class="row">
                <div class="d-inline-flex w-100">
                  <div class="col-6">
                    <label for="partof_day" class="neu-input__label"
                      >Start Time</label>
                      <input
                        :disabled="getDisableDuration(additionalRequestEvent)"
                        name="txtStartTime"
                        :input="startTime"
                        @v-neu-change="getDisableDuration(additionalRequestEvent)"
                        v-bind:class="[
                          'neu-input__text-field',
                          {
                            'readonly_text_field starttimecolor':
                  ...
                  <div class="col-6" v-if="!additionalRequestEvent">
                  ...
                  <div v-if="!additionalRequestEvent">
                    <!-- <neu-select interface="popover" :value="shift" @v-neu-change="getDisableDuration(additionalRequestEvent)" :class="[
                        'neu-input__text-field',
                        {
                          'readonly_text_field bg-transparent':
                            getDisableDuration(additionalRequestEvent),
                        ...
                        <neu-option ref="ddlDurationOptions" v-for="duration in durationList"
                        :value="duration.value"
                        :key="duration.value"
                        v-model="duration">
                            {{ duration.label }}
          ...
          <div class="row pt3">
            <div class="col-12">
              <label for="approval_code" class="neu-input__label"
              ...
              <div v-if="!additionalRequestEvent">
                <neu-textarea
                  ...
                  v-bind:class="[
                    'neu-input__textarea',
                    {
                      'readonly_text_field bg-transparent starttimecolor':
                        widthdrawMode(additionalRequestEvent),
                    },
                  ]"
                ...
                ></neu-textarea>
                <br />
                <span class="commentCharacterCountText"
                  >Remaining
                  {{
              ...
              <div v-if="additionalRequestEvent">
                ...
                <span class="commentCharacterCountText"
                  ...
                  {{
                    maxCommentsCharacters -
                    (data.defaultComment != undefined
                      ? data.defaultComment.length
                      : 0)
                  }}
                  characters.</span
                >
    ...
    <div v-if="isConfirmModalVisible">
      <ConfirmMsgPopUp
        @cancelled="isConfirmModalVisible = false"
        @confirmed="confirmedClicked"
        :msgValue="confirmMsgValue"
      ></ConfirmMsgPopUp>
    </div>
  </div>
</template>
