                ...
                <div class="col-md-12 pb4">
                    ...
                    <div class="row pt3">
                        <div class="col-12">
                            ...
                            <div v-if="!additionalRequestEvent">
                                <neu-textarea placeholder="Enter text here" wrap="off" v-bind:class="[
                                    'neu-input__textarea',
                                    { 'readonly_text_field bg-transparent starttimecolor': widthdrawMode(additionalRequestEvent) },
                                ]" :disabled="widthdrawMode(additionalRequestEvent)" :maxlength="maxCommentsCharacters"
                                    :input="comment" name="Comment"></neu-textarea>
                                <br>
            ...
            <div class="row">
                <div class="col-12">
                    <neu-button @click="FireAction(additionalRequestEvent)"
                        ...
                        data-test="fire-action" :class="['d-block mb4 mt4 neu-button w-100 neu-text--white', disableSubmit(additionalRequestEvent) || isImpersonating
...
import { NeuSelect, NeuSelectNative, NeuTextarea, NeuButton } from '@neutron/vue';
...
export default class Request extends Vue.with(Props) {
    ...
    async FireAction(additionalRequestEvent: any) {
        if (!this.widthdrawMode(additionalRequestEvent)) {
            ...
            var selectedShift = this.availableShifts.find((x: any) => x.id == this.shift);
